...
class CNN_model():
    def __init__(self, nbCategories=None, verbose=False, trainable = False):
    ...
    def train(self, x, y, epochs=5, batch_size = 64, validation_data = None, callback = False):
        if callback == True:
        # checkpoint
...
if __name__ == '__main__':
    ...
    # Training model
    model.train(xTrain, yTrain, epochs=EPOCHS, validation_data = (xTest, yTest), batch_size = BATCH_SIZE)
